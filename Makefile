...
# layout: launcher at bin/codegraph/bin/codegraph beside bin/ARCDESK) and run the
# gated MCP end-to-end test against it. Requires `gh`. Windows: install via the
# upstream install.ps1 and run the test with ARCDESK_CODEGRAPH_BIN set.
e2e-codegraph:
	...
	ARCDESK_CODEGRAPH_E2E=1 ARCDESK_CODEGRAPH_BIN=$$PWD/$$dest/bin/codegraph \
