...
func (m *chatTUI) skillList() {
	...
	if len(skills) == 0 {
		m.notice("no skills found. Add SKILL.md / <name>.md under .arcdesk/skills (project) or ~/.arcdesk/skills (global); .agents/.agent/.claude skills dirs also work. Invoke with /<name> or run_skill.")
		return
	}
