...
func makeTestSkills() []skill.Skill {
	return []skill.Skill{
		{Name: "review", Description: "Review code changes for correctness", Scope: skill.ScopeProject, Path: "/fake/proj/.arcdesk/skills/review/SKILL.md", RunAs: skill.RunSubagent, Body: "# Review\n\nReview code."},
		...
		{Name: "test", Description: "Run tests and validate behavior", Scope: skill.ScopeProject, Path: "/fake/proj/.arcdesk/skills/test.md", RunAs: skill.RunInline, Body: "# Test\n\nRun the tests."},
	}
}
...
func TestSkillPickerSourceView(t *testing.T) {
	skills := makeTestSkills()
	roots := []skillRootLine{
		{dir: "/fake/proj/.arcdesk/skills", scope: skill.ScopeProject, status: skill.StatusOK, skills: 2, diagnostic: true},
	...
	if !strings.Contains(out, ".arcdesk") {
...
func TestSkillPickerDiagnostics(t *testing.T) {
	roots := []skillRootLine{
		...
		{dir: "/proj/.arcdesk/skills", scope: skill.ScopeProject, status: skill.StatusOK, skills: 1, diagnostic: true},
...
func TestSkillPickerDetailShowsActionsBeforeBodyPreview(t *testing.T) {
	s := skill.Skill{
		...
		Path:        "/proj/.arcdesk/skills/review/SKILL.md",
...
func TestPathBoundaryMatching(t *testing.T) {
	skills := []skill.Skill{
		{Name: "alpha", Scope: skill.ScopeProject, Path: "/proj/.arcdesk/skills/alpha/SKILL.md"},
		{Name: "beta", Scope: skill.ScopeProject, Path: "/proj/.arcdesk/skills-extra/beta/SKILL.md"},
	}
	lines := []skillRootLine{
		{dir: "/proj/.arcdesk/skills", scope: skill.ScopeProject, status: skill.StatusOK},
		{dir: "/proj/.arcdesk/skills-extra", scope: skill.ScopeProject, status: skill.StatusOK},
	}
...
func TestLegacySkillShowUnchanged(t *testing.T) {
	s := skill.Skill{
		...
		Scope:       skill.ScopeProject,
		Path:        "/fake/proj/.arcdesk/skills/my-skill.md",
		Body:        "# My Skill\n\nSome body text.",
	}
...
func TestLegacySkillPathsUnchanged(t *testing.T) {
	roots := []skill.Root{
		{Dir: "/proj/.arcdesk/skills", Scope: skill.ScopeProject, Priority: 0, Status: skill.StatusOK},
	}
