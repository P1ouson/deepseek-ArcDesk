...
func TestExpandPastedBlocksImage(t *testing.T) {
	m := &chatTUI{pastedBlocks: []pastedBlock{
		{label: "[image #1]", text: "@.arcdesk/attachments/clipboard-20260601-010203.000001.png", image: true},
		{label: "[Pasted text #2 · 3 lines]", text: "a\nb\nc"},
	}}
	got := m.expandPastedBlocks("look at [image #1] and [Pasted text #2 · 3 lines]")
	want := "look at @.arcdesk/attachments/clipboard-20260601-010203.000001.png and " +
...
func TestDisplayLineForImageRefs(t *testing.T) {
	got := displayLineForImageRefs("describe @.arcdesk/attachments/clipboard-20260601-010203.000001.png @.arcdesk/attachments/clipboard-20260601-010204.000002-000002.jpg")
