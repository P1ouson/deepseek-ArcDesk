...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/ARCDESK.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "ARCDESK.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "ARCDESK.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "arcdesk.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "ARCDESK.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "ARCDESK.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "ARCDESK.md"), "@cycle1.md")
