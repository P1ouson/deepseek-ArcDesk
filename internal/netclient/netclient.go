// Package netclient builds HTTP clients that share ARCDESK's user-facing proxy
...
// NewHTTPClient returns an HTTP client with ARCDESK proxy settings applied.
