// Package builtin provides ARCDESK's compile-time built-in tools. Each tool
...
// at init resolves against the process working directory. roots confines reads
// when non-empty (see ConfineRead).
