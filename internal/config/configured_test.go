...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "arcdesk_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "arcdesk_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "arcdesk_TEST_MISSING"}, false},
