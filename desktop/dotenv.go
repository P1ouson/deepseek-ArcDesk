...
// credentialsPath is the ARCDESK-owned global secrets file the settings panel
// writes API keys to — the same file `ARCDESK setup` writes and config.loadDotEnv
