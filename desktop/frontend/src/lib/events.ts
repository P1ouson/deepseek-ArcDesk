...
export const KNOWLEDGE_RECORDED_EVENT = "ARCDESK:knowledge-recorded";
...
export function notifyKnowledgeRecorded(): void {
  if (typeof window === "undefined") return;
  window.dispatchEvent(new CustomEvent(KNOWLEDGE_RECORDED_EVENT));
}
