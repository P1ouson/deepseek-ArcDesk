...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — ARCDESK end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "arcdesk", "path to the ARCDESK binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 ARCDESK e2e benchmark\n\n")
